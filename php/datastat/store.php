...
$query = " SELECT to_char(stat_date, 'MM-DD') AS dan,
	SUM (CASE WHEN type = 'total' THEN counter ELSE 0 END) AS \"Total\",
	SUM (CASE WHEN type = 'voice' THEN counter ELSE 0 END) AS \"Voice\",
	SUM (CASE WHEN type = 'data' THEN counter ELSE 0 END)AS \"Data\",
	SUM (CASE WHEN type = 'message' THEN counter ELSE 0 END)AS \"Messaging\"
	FROM vs_users_stat $where GROUP BY stat_date  order by stat_date ";
/*print_r($query);
exit;*/
