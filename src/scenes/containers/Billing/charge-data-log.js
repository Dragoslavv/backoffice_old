...
import {ChargeDataLogTable} from "../../components/Table/charge-data-log-table";
    ...
    render() {
        ...
        function Table() {
            if(dataTable.length > 0){
                return <ChargeDataLogTable data={dataTable} />;
            } else {
                return <ChargeDataLogTable data='' />
            }
        }
...
export default withRouter(ChargeDataLog);