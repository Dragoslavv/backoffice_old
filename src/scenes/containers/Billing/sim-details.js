...
import {SimDetailsTable} from "../../components/Table/sim-details-table";
                ...
                <section id="content-wrapper" >
                    <nav aria-label="breadcrumb">
                        <ol className="breadcrumb head-pages wrap-border">
                            ...
                            <li className="breadcrumb-item active" aria-current="page">Sim Details</li>
                        </ol>
                    </nav>
                    <div className="row">
...
export default withRouter(SimDetails);