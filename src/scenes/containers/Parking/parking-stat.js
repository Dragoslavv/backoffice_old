...
import {ParkingStatistic} from "../../components/UserFunctions";
import {Redirect} from "react-router-dom";
import Cookies from "universal-cookie";

class ParkingStat extends Component {
    constructor(props){
        super(props);
    ...
    handleReset = (e) => {
        ...
        ParkingStatistic(this.state.start, this.state.end, this.state.zone).then(result => {
            ...
            if(result.status === true) {
                ...
                const day = [];
                const series = [{name: 'NO. OF CHARGED',data:[]},{name: 'TOTAL',data:[]}];

                result.data.map(function (data) {
                    day.push(data.dan);

                    series[0]['data'].push(data.counter);
                    series[1]['data'].push(data.total);
                        ...
                        <div className="col-lg-2  mb-3">
                            <div className='wrap-border table-col-gui'>
                                ...
                                <form method="post">
                                    ...
                                    <div className='form-group billing-input'>
                                        <select className="input " name="zone" value={this.state.zone} onChange={this.handleChanges}>
...
export default withRouter(ParkingStat);